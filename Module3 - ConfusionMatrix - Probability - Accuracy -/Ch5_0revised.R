...
# load file
toyota.corolla.df <- read.csv("C:/Users/randa/Dropbox/Masters/Winter/TBANLT 560 Data Mining/Files/DMBA-R-datasets/DMBA-R-datasets/ToyotaCorolla.csv", header = TRUE)
...
owner.df <- read.csv("C:/Users/sergi/Documents/dmclass/DMBAdata/ownerExample.csv")
head(owner.df)
...
df <- read.csv("C:/Users/sergi/Documents/dmclass/DMBAdata/liftExample.csv")
