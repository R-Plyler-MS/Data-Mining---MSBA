...
library(e1071)
delays.df <- read.csv("C:/Users/sergi/Documents/dmclass/DMBAdata/FlightDelays.csv")
head(delays.df)
...
train.index <- sample(c(1:10),10*0.6)
...
delays.nb
str(delays.nb)
delays.nb$tables$DAY_WEEK

predict(delays.nb, newdata=train.df)
