...
boston.housing.df <- read.csv("C:/Users/sergi/Documents/dmclass/DMBAdata/BostonHousing.csv", header = TRUE) 
...
library(reshape) 
boston.housing.df <- read.csv("C:/Users/sergi/Documents/dmclass/DMBAdata/BostonHousing.csv")
# create bins of size 1
boston.housing.df$RM.bin <- .bincode(boston.housing.df$RM, c(1:9)) 
...
cereals.df <- read.csv("C:/Users/sergi/Documents/dmclass/DMBAdata/Cereals.csv") 
